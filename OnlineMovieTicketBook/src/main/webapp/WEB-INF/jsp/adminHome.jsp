	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="uploadMovie">Upload Movie</a></li>
				<li><a href="upcomingMovie">View Upcoming Movie</a></li>
				<li><a href="paymentStatus">Update Payment Status</a></li>
				<li><a href="allHistory">All Transaction History</a></li>
			</ul>
